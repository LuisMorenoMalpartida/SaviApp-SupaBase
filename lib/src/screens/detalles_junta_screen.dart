  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Consumer<SaviState>(
            builder: (ctx, state, _) => Text(
                state.nombreJunta.isNotEmpty ? state.nombreJunta : 'Detalles')),
        elevation: 0,
        backgroundColor: Colors.white,
        foregroundColor: Colors.deepOrange,
      ),
      body: SafeArea(
        child: Consumer<SaviState>(builder: (ctx, state, _) {
                      ...
                      SizedBox(
                        ...
                        child: RepaintBoundary(
                          child: _featureCard(
                            ...
                            title: 'Detalles',
                            subtitle:
                                'Consulta para recibir los detalles de tu junta',
                      ...
                      SizedBox(
                        ...
                        child: RepaintBoundary(
                          child: _featureCard(
                            ...
                            subtitle:
                                'Comparte tu junta con tus amigos de confianza',
                      ...
                      SizedBox(
                        ...
                        child: RepaintBoundary(
                          child: _featureCard(
                            ...
                            subtitle:
                                'Registra los tiempos hasta los pagos de cada usuario',
                            icon: Icons.group,
                      ...
                      SizedBox(
                        ...
                        child: RepaintBoundary(
                          child: _featureCard(
                            ...
                            title: 'Reportar',
                            subtitle:
                                'Informa sobre cualquier miembro que incumple la cuota',
                            icon: Icons.flag,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child:
                  Icon(icon, size: 28, color: iconColor ?? Colors.deepOrange),
            ),
            const SizedBox(height: 12),
